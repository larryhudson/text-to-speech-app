...
# Podcast class taken from:
# https://github.com/jeffbr13/django-podcast-feed/blob/master/podcast_feed/__init__.py
...
class AudioFeed(PodcastFeed):
    title = "text-to-speech-app items"
    link = f"http://{config('SERVER_IP')}"
    description = "Audio versions of your text files."
    author = 'Larry Hudson'
    artwork_link = f"http://{config('SERVER_IP')}/static/logo.jpg"
    itunes_category = 'News'
    explicit = False
    owner_name = 'Larry Hudson'
    owner_email = 'larryhudson@hey.com'
